...
public class Main extends JFrame implements MouseListener
{
	...
	private Time timer;
	private BackgroundMusic backgroundMusic, celebrationMusic;
    ...
    {
		try {
			backgroundMusic = new BackgroundMusic("/chess/BackgroundMusic.WAV");
			celebrationMusic = new BackgroundMusic("/chess/CelebrationMusic.WAV");
		} catch (Exception e) {
			e.printStackTrace(); // Handle any exceptions related to file loading
		}
